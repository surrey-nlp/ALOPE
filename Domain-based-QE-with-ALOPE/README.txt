...
##Domain-based QE datasets:
[https://huggingface.co/collections/surrey-nlp/domain-specific-indic-qe-datasets/](https://huggingface.co/collections/surrey-nlp/domain-specific-indic-qe-datasets)
